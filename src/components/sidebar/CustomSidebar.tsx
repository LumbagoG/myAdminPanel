...
// Компоненты
import { CustomLogo as DefaultTitle } from "../index";

// Иконка sidebar по-умолчанию
 ...
 * @constructor
 */
export const CustomSidebar: typeof DefaultSidebar = ({ render }) => {
    // States
    // Состояние collapse
    ...
    return (
        <>
            ...
            >
                <DrawerOverlay />
                <DrawerContent w="200px" maxW="200px" bg="sidebar.background">
            ...
            >
                ...
                <Button
                    ...
                    color="white"
                    bg="sidebar.collapseButton"
                    borderRadius={0}
                    _hover={{ bg: "sidebar.collapseButton" }}
                    _active={{
                        bg: "sidebar.collapseButton",
                        transform: "translateY(1px)",
                    }}
